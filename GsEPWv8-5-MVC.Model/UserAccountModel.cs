...
{
    public class UserAccountdtlModel : BasicEntity
    {
    ...
    public class UserAccountScreenDtl
    {
        public string user_id { get; set; }
        public string scn_id { get; set; }
        public string scn_view { get; set; }
    ...
    public class UserAccountModel : UserAccountdtlModel
    {        
