...
{
    public class ContainerArrivalController : Controller
    {
        ...
        public ActionResult DashboardContainerArrival(string FullFillType, string cmp, string screentitle)
        {
        ...
        public ActionResult DashboardConatinerArrivalGrid(string p_str_cmpid, string p_str_whsId, string p_str_contId, string p_str_event)
        {
            ContainerArrival objContainerArrival = new ContainerArrival();
            IContainerArrivalService ServiceObject = new ContainerArrivalServiceService();
            ...
            return PartialView("_DashboardContainerArrival", objContainerArrivalModel);
        }

        public ActionResult CompanyAdd(string p_str_cmpid)
        {
            ContainerArrivalModel objContainerArrivalModel = new ContainerArrivalModel();
